        ...
        <TouchableOpacity style={styles.listItem}>
              ...
              >
                ...
                <View style={{ marginLeft: "15%" }}>
                  ...
                  <Text style={styles.textStyle}>{"Hey! Would you like to join our basketball group?"}</Text>
                </View>
              </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.listItem}>
              ...
              >
                ...
                <View style={{ marginLeft: "15%" }}>
                  ...
                  <Text style={styles.textStyle}>{"See you tommorrow!"}</Text>
                </View>
              </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.listItem}>
        ...
        <TouchableOpacity style={styles.listItem}>
              ...
              >
                ...
                <View style={{ marginLeft: "15%" }}>
                  ...
                  <Text style={styles.textStyle}>{"Had a fun time yesterday!"}</Text>
                </View>
              </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.listItem}>
              ...
              >
                ...
                <View style={{ marginLeft: "15%" }}>
                  ...
                  <Text style={styles.textStyle}>{"We'll be playing again tomorrow."}</Text>
                </View>
              </View>
        </TouchableOpacity>
      </View>
